...
export class ProductoService {
  ...
  insert_producto(data: {
    ...
    precio_compra: string | Blob;
    precio_venta: string | Blob;
    stock: string | Blob;
    idcategoria: string | Blob;
  }) {
  ...
  update_producto(data: {
    ...
    return this.http.put(this.url + 'producto/editar/' + data._id + '/', fd);
  }

  insert_categoria(data: any): Observable<any> {
    let headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this.http.post(this.url + 'categoria/registrar', data, {
      headers: headers,
    });
  }
  ...
  delete_categoria(id: string): Observable<any> {
    let headers = new HttpHeaders().set('Content-Type', 'application/json');
  ...
  stock_producto(data: { _id: string }): Observable<any> {
    let headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this.http.put(this.url + 'producto/stock/' + data._id, data, {
      headers: headers,
    });
  }
}
